...
def updateTf(transform_brodcaster, tf_buffer, delta_s, delta_theta, pub_initial):
    
    if pub_initial:
        transform_brodcaster.sendTransform(getInitialTf())
        pub_initial = False
        return
...
def main():
    ...
    while not rospy.is_shutdown():
        updateTf(transform_broadcaster, tf_buffer, delta_s, delta_theta, pub_initial)
        pub_initial = False
        rate.sleep()
